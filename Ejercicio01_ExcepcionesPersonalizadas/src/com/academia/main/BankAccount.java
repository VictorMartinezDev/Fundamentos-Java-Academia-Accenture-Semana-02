...
import com.academia.log.TransactionLog;
...
public class BankAccount {
    ...
    public void withdraw(double amount) throws InsufficientBalanceException {
        ...
        else if(amount > balance) throw new InsufficientBalanceException("Balance menor al monto", amount); 
    ...
    public void transfer(BankAccount target, double amount) throws InsufficientBalanceException {
    	...
    	try(TransactionLog log1 = new TransactionLog()){
    		
    		withdraw(amount);
    		log1.log("Retiro de $"+amount+" de cuenta origen. Saldo: $"+ balance);
    		target.deposit(amount);
    		log1.log("Deposito de $"+amount+" a cuenta destino. Saldo: $"+target.getBalance());
    	}
